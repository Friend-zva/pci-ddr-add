...
create_clock -name ddr_clk -period 2.5 -waveform {0 1.25} [get_nets {ddr_clk}]
set_clock_groups -asynchronous -group [get_clocks {div_clk}] 
                               -group [get_clocks {ddr_clk_out}] 
